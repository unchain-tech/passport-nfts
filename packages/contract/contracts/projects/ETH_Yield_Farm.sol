...
contract ETH_Yield_Farm is IProject, ERC721URIStorageUpgradeable {
  // Token info
  ...
  function initialize() public initializer {
    ...
    _projectName = 'ETH Yield Farm';
    _passportHash = 'QmcKaf9bLvMAzjAwYXwAQTaQVvtkffFKfpBRpGgBP71c1p';
