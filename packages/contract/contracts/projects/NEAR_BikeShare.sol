...
contract NEAR_BikeShare is IProject, ERC721URIStorageUpgradeable {
  // Token info
  ...
  function initialize() public initializer {
    ...
    _projectName = 'NEAR BikeShare';
    _passportHash = 'QmTMBFX6deyz2sqa92RDPTKrkxo7B3ZDw8YrSBuxbbxo7f';
