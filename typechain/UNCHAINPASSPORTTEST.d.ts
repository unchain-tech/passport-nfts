...
interface UNCHAINPASSPORTTESTInterface extends ethers.utils.Interface {
  functions: {
...
export class UNCHAINPASSPORTTEST extends BaseContract {
  ...
  interface: UNCHAINPASSPORTTESTInterface;
